...
if (isset($_GET["displayId"])) {
    $adminId = $_GET["displayId"];
} else {
    $adminId = $_SESSION['AdminId'];
}

$query = "SELECT * FROM `tbladdadmin` WHERE Id = $adminId";
...
if ($result) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $Gender =  $row["Gender"];
        $employeeprofile = $row["adminprofile"];
    }
}
...
<head>
    ...
    <link rel="stylesheet" href="../Employee/css/employeeprofile.css" />
                        ...
                        <form method="POST">
                            ...
                            <div class="content">
                                <div class="input-box">
                                    ...
                                    <input type="text" placeholder="Enter Your First Name" name="Fname" value=<?php echo $adminId; ?> required>
                                </div>
                                <div class="input-box">
