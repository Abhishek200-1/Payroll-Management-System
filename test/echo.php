...
<body>
    ...
    <div class="my-5 mx-2">
        <div class="button-container">
            <button type="button" class="btn btn-info"><a href="../add-employee.php">Add New Employee</a></button>
        </div>
        <h3>Employee Detailes</h3>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) 
                        {
                            ...
                            '<tr>
                                <th scope="row">' . $Emp_Id . '</th>
                                    ...
                                    <td>' . $Gender . '</td>
                                <td>
                                    <a href="../../Backend/Update/update-add-employee.php? updateid=' . $Emp_Id . '" class="link-dark"><i class="fa-solid fa-pen-to-square fs-4 me-4"></i></a>
                                    <a href="../../Backend/Update/delete-add-employee.php? deleteid=' . $Emp_Id . '" class="link-dark"><i class="fa-solid fa-trash fs-5 "></i></a>
                                </td>
                            </tr>';
                        }
                    }
